...
function DebtsTemplate(
  args: Partial<React.ComponentProps<typeof RepeatableFieldList<Debt>>>
) {
...
export const WithError: Story = {
  args: {
    items: [],
    error:
      'Please add at least one debt, or select "No" above if you have none',
  },
};
